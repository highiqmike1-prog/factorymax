package net.mcreator.factorymax;
...
@Mod("factorymax")
public class FactorymaxMod {
	public static final Logger LOGGER = LogManager.getLogger(FactorymaxMod.class);
	public static final String MODID = "factorymax";

	public FactorymaxMod(IEventBus modEventBus) {
